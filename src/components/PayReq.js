...
const PayReq = () => {
    ...
    return ( 
        ...
        <div className='flex flex-col justify-between items-center w-full h-fit'>
            ...
            <button className='bg-filler text-bgwhite w-[80%] h-10 mt-4 mb-4' onClick={()=>confirm()}>Confirm</button>
            <button className='bg-filler text-bgwhite w-[80%] h-10 mt-4 mb-4' onClick={()=>sendReq()}>Send Request</button>
